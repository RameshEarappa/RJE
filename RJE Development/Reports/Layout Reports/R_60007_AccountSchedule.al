report 60007 "Ext. Account Schedule"
{
    DefaultLayout = RDLC;
    RDLCLayout = 'RJE Development\Reports\Layout Reports\ExtAccountSchedule.rdl';
    AdditionalSearchTerms = 'financial reporting,income statement,balance sheet';
    ApplicationArea = Basic, Suite;
    Caption = 'Ext. Account Schedule';
        ...
        dataitem(AccScheduleName; "Acc. Schedule Name")
        {
            ...
            dataitem(Heading; "Integer")
            {
                ...
                dataitem("Acc. Schedule Line"; "Acc. Schedule Line")
                {
                    ...
                    //10.11.2020
                    column(DescriptionArabic; "Description (Arabic)")
                    {
                    }
                    //10.11.2020
