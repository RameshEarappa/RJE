xmlport 50108 "DMS Universal XMLport"
{
    // ************************
    // Copyright Notice
    // 
                ...
                group(Filename)
                {
                    ...
                    field(txtFileName; txtFileName)
                    {
                        ...
                        var
                            ...
                            Instr: InStream;
                        begin
                            //below functions are obselete so skipping filename as this is optional-Krishna 25FEB2021
                            //ltxtFilename := lcuFileMgmt.OpenFileDialog(tcFileDlgTitle, txtFileName, tcFileFilter);
                            //UploadIntoStream(tcFileDlgTitle, '', tcFileFilter, ltxtFilename, Instr);
